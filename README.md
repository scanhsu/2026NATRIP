...
- **行程**：D1–D18 每日卡片（路線、里程、住宿、電力、步道、備註），D1/D3/D14/D15/D16 含逐時行程，並附 Google Maps 連結與一鍵導航
...
行程資料以第 7 版（2026/07）為基礎，套用於 D1（寬鬆版時間軸）、D2（上午改西雅圖水族館）、D16（飛行博物館移入，保留 05:45 叫車 + 入境預檢）與訂位／待辦／步道等分頁。
